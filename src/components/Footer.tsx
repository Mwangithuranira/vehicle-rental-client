...
const Footer = () => {
  return (
    ...
    <nav>
    <h6 className="footer-title">PrimeCars</h6>
    <p className="link link-hover">Location</p>
    <p className="link link-hover">Call</p>
    <p className="link link-hover">Email</p>
  </nav>
  <nav>
  ...
  <nav>
    ...
    <a className="link link-hover">Partner Network</a>
    <a className="link link-hover">Developer</a>
  </nav>
  <nav>
    <h6 className="footer-title">About PrimeCars</h6>
